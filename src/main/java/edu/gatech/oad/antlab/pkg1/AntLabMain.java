 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Oleg Filatov");
		  toPrint += p1.toString("ofilatov3");
		  
                  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Callie Bivings");
		  toPrint += p2.toString("cbivings3");
		  
                  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Michael Beyrouti");
		  toPrint += p3.toString("mbeyrouti3");
                  
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Ilya Gurevich");
                  toPrint += p4.toString("igurevich3");
                  
                  //Person5 replace P5 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Christopher Tam");
                  toPrint += p5.toString("ctam8");
                  
                  //Person6 replace P6 with your name
                  //and gburdell6 with your gt id
                  Person6 p6 = new Person6("Christopher Tam");
                  toPrint += p6.toString("ctam8");
